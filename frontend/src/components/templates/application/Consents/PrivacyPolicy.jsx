...
const Section = () => {
  return (
    <Wrapper>
      <ul className="list">
        <li>
          <H3>WHAT DOES ISTANTE LENDING DO WITH YOUR PERSONAL INFORMATION?</H3>
        </li>
        <li>
          <H4>Why?</H4>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            the reasons Istante Lending chooses to share; and whether you can
            limit this sharing.
          </p>
        </li>
        <li>
              ...
              <div className="thead col-3">
                <div className="tr">
                  ...
                  <div className="td center">
                    Does Istante Lending, LLC share?
                  </div>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <p>
                Visit us online:
                <a href="www.istantelending.com" className="link underline">
                  www.istantelending.com
                </a>
                or email us at
                <a
        ...
        <li>
          ...
          <p>
            ...
            or go to
            <a
              href="http://www.istantelending.com"
              target="_blank"
            ...
            <Table className="table col-2">
              ...
              <div className="tbody col-2">
                <div className="tr">
                  ...
                  <div className="td">
                    This privacy notice is provided by Istante Lending.
                  </div>
                </div>
              </div>
              ...
              <div className="tbody col-2">
                <div className="tr">
                  <div className="td">
                    <b>
                      How does Istante Lending protect my personal information?
                    </b>
                  </div>
                  <div className="td">
                ...
                <div className="tr">
                  <div className="td">
                    <b>
                      How does Istante Lending collect my personal information?
                    </b>
                  </div>
                  <div className="td">
                    <div>
              ...
              <div className="tbody col-1">
                <div className="tr">
                  <div className="td">
                    <p>
                      Tribal Notice: Istante Lending is an arm of the Mechoopda
