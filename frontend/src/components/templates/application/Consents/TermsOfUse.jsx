        ...
        <ul className="list">
          <li>
            <p>
              ...
              which are operated by Istante Lending (<b>"Istante Lending"</b> or{" "}
              <b>"Lender"</b>), and your access and use of any of the services
              that Istante Lending provides or offers through a Site
          ...
          <li>
            <p>
              <b>
                LENDER IS AN ARM OF THE TONTO APACHE TRIBE OF INDIANS, A
                ...
                FINANCIAL SERVICE REGULATORY AUTHORITY (THE "AUTHORITY") IN
          ...
          <li>
            ...
            <p>
              Istante Lending reserves the right in its sole discretion to
          ...
          <li>
            ...
            <p>
              ...
              access of Istante Lending’s systems and misuse of passwords or
              Site information is strictly prohibited. If you violate any of
              these Terms of Use or any other agreement between you and Istante
              Lending, then Istante Lending may restrict, suspend, or terminate
          ...
          <li>
            ...
            <p>
              ...
              to our satisfaction and at our sole discretion. Rev. 04/2022 You
              authorize your wireless operator to disclose your mobile number,
              name, address, email, network status, customer type, customer
              role, billing type, mobile device identifiers (IMSI and IMEI) and
              other subscriber and device details, if available, to Istante
              Lending and service providers for the duration of the business
              relationship, solely for identity verification and fraud
              avoidance. See Istante Lending’s Privacy Policy at{" "}
              <a
                href="http://www.istantelending.com/privacy"
                target="_blank"
                rel="noreferrer"
                className="link"
              >
                www.istantelending.com/privacy
              </a>{" "}
          ...
          <li>
            ...
            <p>
              ...
              Istante Lending’s Privacy Policy, which is incorporated by
              ...
              . You agree to Istante Lending’s use of your data in accordance
          ...
          <li>
            ...
            <p>
              ...
              property of Istante Lending with all rights reserved. Site Content
              may not be copied, reproduced, distributed, republished,
              displayed, posted, transmitted, or sold in any form or by any
              means without Istante Lending’s prior written consent. You
              acknowledge that all Site Content is and shall remain the sole
              property of Istante Lending. You may only access a Site and use
              the Services for their intended purpose, and any use of a Site or
          ...
          <li>
            ...
            <p>
              ...
              or right to use any trademark, whether owned by Istante Lending or
          ...
          <li>
            ...
            <p>
              Because Istante Lending operates its platform online and conducts
          ...
          <li>
            <p>
              <b>Electronic Communications:</b> You agree that Istante Lending,
          ...
          <li>
            <p>
              ...
              the free version of Adobe Reader, click{" "}
          ...
          <li>
            <p>
              <b>Additional Mobile Technology Requirements:</b>If you access our
              Site and Communications electronically via a mobile device (such
              as a smart phone or tablet) or if you download and use our Mobile
              App, then in addition to the above requirements, you must make
              sure that you have software on your mobile device that allows you
              to print and save the Disclosures presented to you during the
          ...
          <li>
            <p>
              <b>Requesting a Paper Copy:</b> Copy: You may request from us a
              paper copy of any Communication that we have provided or made
              available to you electronically without charge, provided that such
              request is made within 20 business days after we first provided
              the Communication to you. To request paper copies, you must send
              an e-mail to{" "}
              <a
                href="mailto:DocumentRequest@IstanteLending.com"
                className="link"
              >
                DocumentRequest@IstanteLending.com
              </a>{" "}
              ...
              submit your request by mail to Istante Lending, Tonto Apache
              Reservation #30, Payson, AZ 85541, Attention: Compliance
          ...
          <li>
            <p>
              ...
              <a href="mailto:CustomerCare@IstanteLending.com" className="link">
          ...
          <li>
            <p>
              ...
              logging into your account through Istante Lending’s Account
              Portal, by calling us at (800) 416-5770, or by emailing us at{" "}
              <a href="tel:800-416-5770" className="link">
                800-416-5770
              </a>
              ...
              , or by writing to us at Istante Lending, Tonto Apache Reservation
              #30, Payson, AZ 85541, Attention: Compliance Department.
            </p>
          </li>
          <li>
            <p>
              <b>Your Electronic Signature:</b>Your "electronic signature" means
              ...
              by you with the intent to sign the record. Electronic signatures
              may also be obtained by email, text messages, faxes, or recorded
              touch tone capture files. For example, if you were to reply
              "Agree" to a text message referencing an agreement or push a
          ...
          <li>
            <p>
              ...
              anyone calling on our behalf (collectively,{" "}
              <b>"Representatives"</b>) at any telephone number (including any
              mobile phone number) you provide to us and any physical or
              electronic address you provide to us, and you agree that we may
              use multiple means to contact you including, but not limited to,
              SMS messaging or other text messaging, autodialed or prerecorded
              messages, direct drop voicemail, push notifications, email and
              other technologies. You agree that automated messages may be
              played when the telephone is answered, whether answered by you or
              someone else, and an agent or representative may leave a message
              on your answering machine, voicemail or by text. Your provider's
              messaging and data rates may apply to all SMS text messages. You
              may opt out of receiving SMS messages by: (1) sending "STOP" to
              the SMS text message you received; (2) calling us at{" "}
              <a href="tel:800-416-5770" className="link">
                800-416-5770
              </a>{" "}
          ...
          <li>
            <p>
              ...
              at{" "}
              <a
                href="mailto:OptOut@IstanteLending.com"
                className="link underline"
              >
                OptOut@IstanteLending.com
              </a>{" "}
              or write to us at Istante Lending, 1920 Alcott Ave., Chico, CA
              95926 Attention: Compliance Department. If you wish to change or
          ...
          <li>
            <p>
              ...
              , or via regular mail at Istante Lending, Tonto Apache Reservation
              #30, Payson, AZ 85541, Attn: Legal Department. In your
              notification, please:
            </p>
            <ol>
              <li>
          ...
          <li>
            <p>
              ...
              information. Istante Lending does not warrant or endorse and does
              ...
              Services, you acknowledge and agree that Istante Lending is not
          ...
          <li>
            <p>
              ...
              Istante Lending makes no representation that such Third-Party
              ...
              for compliance with all applicable laws. Istante Lending reserves
              ...
              no event will Istante Lending be liable for the removal of or
              disabling of access to any such Third-Party Services. Istante
          ...
          <li>
            <p>
              ISTANTE LENDING PROVIDES ITS SITE AND SERVICES "AS IS" AND "AS
              AVAILABLE" WITH ALL FAULTS AND WITHOUT ANY EXPRESS OR IMPLIED
              WARRANTIES INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF
              MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
              NON-INFRINGEMENT. ADDITIONALLY, ISTANTE LENDING MAKES NO CLAIM OR
          ...
          <li>
            <p>
              IN NO EVENT WILL ISTANTE LENDING OR ITS DIRECTORS, OFFICERS, OR
              ...
              FROM YOUR USE OF THE SITE OR SERVICES, EVEN IF ISTANTE LENDING IS
          ...
          <li>
            <p>
              You agree to indemnify, defend, and hold harmless Istante Lending
          ...
          <li>
            <p>
              <b>How to Reject this Arbitration Agreement.</b> TTo reject this
              ...
              number) and address. Your notice must be mailed to Istante
              Lending, Tonto Apache Reservation #30, Payson, AZ 85541 or emailed
              to{" "}
              <a href="mailto:CustomerCare@IstanteLending.com" className="link">
                CustomerCare@IstanteLending.com
              </a>
          ...
          <li>
            <Note
              content={[
                ...
                notice on or before the "Arbitration Rejection Date," which is (a) 30 days after the date you applied for a loan,
                or, in the event you obtained a loan, (b) 30 days following the origination date set forth at the top of your loan
                agreement.`,
                `
                Rejection notices that are sent to any other address or are communicated verbally or are sent or
                postmarked after the Arbitration Rejection Date will not be accepted or effective.
                  `,
              ]}
            />
          </li>
            ...
            <ul>
              <li>
                <p>
                  ...
                  the <b> TONTO APACHE TRIBAL COURT</b> in Payson, Arizona;
                </p>
              </li>
              <li>
                <p>
            ...
            <ol className="arbitration-agreemnet-notes">
              <li>
                <p>
                  ...
                  Istante Lending, Istante Lending&apos;s agents, servicers,
                  assigns , vendors and any third-party, Istante Lending&apos;s
              ...
              <li>
                <p>
                  ...
                  <a
                    href="disputes@IstanteLending.com"
                    className="link underline"
                  >
                    disputes@IstanteLending.com
                  </a>
              ...
              <li>
                <p>
                  ...
                  the sovereign status of Istante Lending or expand the scope of
                  the limited waiver provided by Istante Lending below in the
              ...
              <li>
                <p>
                  ...
                  courts therefrom. Istante Lending grants a limited waiver of
                  ...
                  courts therefrom. This limited waiver is made by Istante
          ...
          <li>
            <p>
              ...
              Tonto Apache Consumer Finance Services Commission.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <span className="underline">Waiver:</span> Istante Lending&apos;s
          ...
          <li>
            <p>
              ...
              , email us at{" "}
              <a href="mailto:Compliance@IstanteLending.com" className="link">
                Compliance@IstanteLending.com
              </a>{" "}
              or write to Istante Lending, Tonto Apache Reservation #30, Payson,
              AZ 85541, Attention: Legal Department.
            </p>
          </li>
