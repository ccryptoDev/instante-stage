    ...
    <Wrapper className="new-page">
      ...
      <ol>
        ...
        <li>
          ...
          <br />
          ISTANTE or you may terminate this Agreement with or without cause. It
          may take ISTANTE or your financial institution up to 10 business days
          to process any request to terminate this agreement. Please note that
          ISTANTE reserves the right to terminate this Agreement if it receives
          two consecutive insufficient funds return. ISTANTE is also authorized
          under this Agreement to collect by Auto Payment any additional fees
          due under your loan agreement, as well as fees charges by ISTANTE
          ...
          terminate Auto Payments by providing timely notice to ISTANTE either
          in writing via email to{" "}
          <a href="mailto:CustomerCare@IstanteLending.com" className="link">
            CustomerCare@IstanteLending.com
          </a>{" "}
          or verbally by calling 800-416-5770. Please note that ISTANTE must
        ...
        <li>
          ...
          <br />
          This Agreement is not assignable by you, however ISTANTE may, at any
          ...
          ISTANTE may assign or sell its rights and obligations under this
          ...
          ISTANTE of its rights and obligations hereunder to any third-party.
          <br />
          If ISTANTE initiates a change to your weekly loan payment amount, the
          ...
          Auto Payment Authorization Agreement to ISTANTE which will take up to
        ...
        <li>
          ...
          <br />
          ISTANTE may disclose information to third parties regarding your bank
          ...
          <ol className="list-letters">
            ...
            <li>If you give ISTANTE written permission to do so.</li>
          </ol>
        </li>
        <li>
          <b>Other Agreements and Regulations</b>
          <br />
          ISTANTE reserves the right, upon notice to you, to make changes to the
        ...
        <li>
          ...
          from ISTANTE which reflects your Auto Payments.
        </li>
        <li>
          <b>Definitions</b>
          <br />
          ...
          <ol className="list-letters">
            <li>
              Loan means each loan issued by ISTANTE to Borrower under the
            ...
            <li>
              ISTANTE shall include any purchaser of your loan, any successor
              servicer any agent retained by ISTANTE to conduct Auto Payments
