...
const PaymentAuthorization = ({
  ...
  const img = isPdf
    ? `${process.env.REACT_APP_ADMIN_BASE_URL}/api/application/s3asset/istante-logo-dark.svg`
    : logo;

  const paycheck = isPdf
    ? `${process.env.REACT_APP_ADMIN_BASE_URL}/api/application/s3asset/paycheck.png`
    : paycheckImg;
  return (
    <Wrapper className="new-page">
      <div className="header">
        <div className="logo">
          <img src={img} alt="IstanteLending" />
        </div>
        <div className="address">
          Tonto Apache Reservation #30 <br />
      ...
      <p>
        ...
        <b>“Istante,” “Lender,” “we,” “us” or “our,”</b>
        it means Istante Lending, LLC. This Agreement also incorporates by
      ...
      <p>
        By signing below, I authorize Istante Lending, LLC (“ISTANTE”) to
        initiate weekly deductions from my bank account below in the amount
        equal to the sum of my weekly scheduled loan payment, plus, if
        applicable, any additional amounts set forth below, and any late fees or
        other amounts owed under the terms of my loan agreement.
      </p>
      <p>I understand and acknowledge that:</p>
      <ul>
        <li>
          <p>
            ISTANTE will begin to deduct weekly payments from my bank account on
        ...
        <li>
          <p>
            This agreement is not assignable by me, however ISTANTE may, at any
        ...
        <li>
          <p>
            This authorization will remain in effect until terminated by ISTANTE
            or by me either in writing via email to
            CustomerCare@IstanteLending.com, or verbally by calling
            800-416-5770. Please include your name, address, and loan account
            number and, if via email include “Withdraw Automatic Payment
            Authorization” in your termination notice as failure to include your
            identifying information may delay our ability to process your
            request.
            <b>
        ...
        <li>
          <p>
            In the event, I terminate this agreement, I understand that ISTANTE
