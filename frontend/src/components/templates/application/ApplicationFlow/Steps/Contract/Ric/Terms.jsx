  ...
  return (
    <Wrapper>
      <div className="terms-section-wrapper">
        <div className="info-wrapper">
          <div className="info-block">
            <b>Lender:</b>
            <ul>
              <li>ISTANTE LENDING, LLC</li>
              <li>Tonto Apache Reservation #30</li>
              <li>Payson, Arizona 85541</li>
            </ul>
          </div>
          <div className="info-block">
            <b>Borrower Name:</b>
        ...
        <p>
          <b>Loan Agreement for Istante Lending LLC Personal Loan Program</b>
        </p>
        <p>
          ...
          mean&nbsp;
          <b>ISTANTE LENDING LLC,</b> Payson, Arizona, its successors and
          assigns, and any other holder of my Loan; when it references
          <b> “Tribe,” “tribe,” “Tribal” </b>or&nbsp;
          <b>“tribal,”</b> it means the Tonto Apache Tribe.
        </p>
        <p>
          I understand that you are located on Tonto Apache Tribal Lands and
          ...
          Tribe or the Tonto Apache Consumer Finance Services Commission. I
          ...
          Application, my Loan and ISTANTE LENDING LLC.
        </p>
      </div>
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          <b>3. </b>
          Decreasing the Total Loan Amount– You can decrease the Total Loan
          Amount (i) based on updated payoff information you subsequently
          receive on the Prior Debts I have identified in my Application, (ii)
          if I ask you in writing to remove a Prior Debt from this Loan after I
          provide this signed Loan Agreement but prior to disbursement, or (iii)
          by refusing to disburse Loan proceeds to the holders of my Prior Debts
          if doing so is prohibited by law.
        </p>
        <p>
          <b>4. </b>
          Updated Payoff Information– If after Loan proceeds are disbursed on my
          behalf, I receive updated payoff information showing that additional
          amounts remain owing on the Prior Debts I have identified for payoff,
          I will promptly pay the holders of my Prior Debts the additional
          amounts that remain owing on my Prior Debts and you will not be
          responsible in any way for paying off those amounts.
        </p>
        <p>
          <b>5. HOW I AGREE TO THE TERMS OF THIS LOAN.</b>
          If you agree to make a Loan to me, you will send me a Disclosure
          Statement under the Federal Truth in Lending Act. The Disclosure
          Statement will tell me the Total Loan Amount, the annual percentage
          rate on my Loan, and the amount of any fees. The Disclosure Statement
          is incorporated herein by this reference. My contractual obligation on
          this Loan Agreement will begin when Loan proceeds are disbursed to me
          or to the holders of my Prior Debs. To the extent any information in
          the Disclosure Statement conflicts with the information in this Loan
          Agreement, the information in the Disclosure Statement governs.
        </p>
      </div>
      <div className="terms-section-wrapper no-break-column">
        <p>
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          ...
          <b>ISTANTE LENDING, LLC,</b> Tonto Apache Reservation #30, Payson,
          Arizona 85541, or any future address or electronic method you provide
          me.
        </p>
        <p>
          <b>2. </b> Any communication between you and the Borrower or any
        ...
        <p>
          <b>3. </b> ISTANTE LENDING, LLC is licensed by the Tribal Financial
          Services Regulatory Authority, License Number I-204-1730, Tonto Apache
          Reservation #30, Payson, Arizona 85541. ISTANTE LENDING, LLC is an arm
          of the Tonto Apache Tribe (Tribe), a federally recognized Indian
          Tribe. It is owned and operated pursuant to Tribal Law, and it was
          formed for the express purpose of economic development and betterment
          of the Tribe. Both ISTANTE LENDING, LLC and the Tribe are immune from
          suit in any court except to the extent that the Tribe, through its
          Tribal Council, expressly and unequivocally waives that immunity. As
          an arm of the Tribe, ISTANTE LENDING, LLC is also immune from suit in
          any court except as provided in the limited immunity waiver contained
          herein.
        </p>
        <p>
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          <b>1. EFT Payment Option:</b> For my convenience and benefit, I may
          choose to make payments by EFT. My receipt of this Loan is not
          conditioned on repayment by EFT. I may pay each payment owing under
          this Agreement by EFT debit, check, money order or any other payment
          method that you may offer from time to time.
        </p>
        <p>
          <b>2. EFT Authorization To Credit Bank Account:</b> Unless I elect to
          receive the Loan proceeds by check as set forth in Section O.3. below,
          I authorize you and your agents to initiate an EFT credit entry to my
          Bank Account to disburse the proceeds of this Loan.
        </p>
        <p>
          <b>3.EFT Authorization To Debit Bank Account:</b> If I elect to repay
          amounts due on my Loan by EFT debit, then recurring withdrawals will
          be initiated as EFT debit entries from my Bank Account pursuant to and
          in accordance with the terms of my Automatic Payment Authorization
          Form agreement, this Agreement, and any modifications or adjustments
          to my Payment Schedule or my Agreement that you may agree to make. If
          my payment date falls on a Saturday, Sunday or bank-recognized
          holiday, then my EFT debit will be processed one business day BEFORE
          that payment date.
        </p>
        <p>
          <b>4. Check Processing:</b> If I provide a check as payment, I agree
          you may use information from my check to make a one-time electronic
          withdrawal from my Bank Account or process the payment as a check
          transaction. In that event, funds may be withdrawn from my Bank
          Account as soon as the same day you receive my payment and I will not
          receive my check back from my financial institution.
        </p>
        <p>
        ...
        <p>
          <b>1. ACH Credit:</b> No additional fee is charged by Istante if I
          choose to receive my Loan proceeds by ACH credit but there may be a
          delay of 1 to 2 business days before the funds post to my account due
          to processing and hold times, which may be imposed by the originating
          and receiving financial institutions and/or their agents.
        </p>
        <p>
          <b>2. Wire Transfer Credit:</b> No additional fee is charged by Lender
          if I choose to receive my Loan proceeds by wire transfer, but I will
          be responsible for any fees that my financial institution may impose.
        </p>
        <p>
        ...
        <p>
          <b>4. Debit Card Credit:</b> No additional fee is charged by Lender if
          I choose to receive my Loan proceeds by debit card credit, but I will
          be responsible for any fees that my financial institution may impose.
        </p>
      </div>
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          <b>1. Consent to Electronic Delivery:</b>I agree that Istante, its
        ...
        <p>
          ...
          send an e-mail to customercare@Istantelending.com with the subject
          line “Paper Copy Request” and in the body of the email I must state my
          ...
          Istante Lending, LLC, Tonto Apache Reservation #30, Payson, Arizona
          85541, Attention: Compliance Department. There is no fee for the paper
          copy.
        </p>
        <p>
          ...
          e-mailing you in writing at: customercare@Istantelending.com with the
        ...
        <p>
          ...
          electronic Communications, I must have the following: (1)access to the
          internet; (2) an active email account; (3) software capable of
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          ...
          <b>
            ...
            marked for special handling and sent to{" "}
            <span className="underline">ISTANTE LENDING, LLC</span>, PO Box 29,
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <p>
          <b>4.</b> I authorize you or your agents to: (1) gather and share from
          time to time credit-related, employment and other information about me
          (including any information from the Loan Agreement or about this Loan
          or my payment history) from and with consumer reporting agencies, and
          others in accordance with Applicable Law; (2) respond to inquiries
          from prior or subsequent lenders or holders or loan servicers with
          respect to my Loan and related documents; and (3) release information
          and make inquiries to the persons I have listed in my Application as
          employers and references. My authorization under this Section O
          applies to this Loan, any future loans that may be offered to me by
          you, any updates, renewals or extensions of this Loan that may be
          offered to me, any hardship forbearance of this Loan or any future
          loans that may be requested by me, and for any review or collection of
          this Loan or any future loans that may be offered to me. I understand
          that a credit report is obtained for this Loan request. If you agree
          to make this Loan to me, a consumer credit report may be requested or
          used in connection with renewals or extensions of any credit for which
          I have applied, reviewing my Loan, taking collection action on my
          Loan, or legitimate purposes associated with my Loan. If I live in a
          community property state, I authorize you to gather credit- related
          information from others about my spouse. If I ask you, you will tell
          me if you have requested information about me (or about my spouse if
          applicable) from a consumer reporting agency and provide me with the
          name and address of any agency that furnished you with a report.
        </p>
        <p>
      ...
      <div className="terms-section-wrapper no-break-column">
        ...
        <div className="border padding-10">
          <p>
            ...
            address. My notice must be mailed to Istante Lending, LLC, Tonto
            Apache Reservation #30, Payson, Arizona 85541 or emailed to{" "}
            <a
              href="mailto: legal@Istantelending.com"
              target="_bank"
              className="link-string link link"
            >
              legal@Istantelending.com
            </a>
            .{" "}
            <span className="underline">
              Lender must receive my notice on or before the “Arbitration
              Rejection Date,” which is 45 days after execution of my Loan
              Agreement.
            </span>{" "}
          ...
          <ul className="padding-left-20">
            <li>
              <p>
                ...
                SUBJECT MATTER JURISDICTION of the TONTO APACHE COURT in
                Arizona.
              </p>
            </li>
            <li>
        ...
        <p>
          ...
          representative, or trustee in bankruptcy; the terms
          <b> “you”</b> and <b>“your”</b> mean Lender, Lender’s agents,
          servicers, assigns, vendors and any third-party, Lender’s affiliated
          companies, and each of its and their respective agents,
          representatives, employees, officers, directors, members, managers,
          attorneys, successors, predecessors, and assigns. Any claim, dispute
          or controversy of any kind or nature between you and I about or
          involving my Loan, my Loan account, any prior loans or accounts I held
          with you (collectively <b> “loan account”</b>), my current Loan
        ...
        <p>
          ...
          Dispute by sending an email to legal@Istantelending.com. My email must
        ...
        <p>
          ...
          the United States District Court for the Northern District of Arizona
          or the courts of the state of Arizona sitting in Kay County to appoint
          the arbitration service provider, as permitted under 9 U.S.C. § § 5.
          (The AAA and any substitute arbitration service provider selected or
        ...
        <p>
          ...
          for the Northern District of Arizona or if such federal court fails to
          find jurisdiction, then in the courts of the state of Arizona sitting
          in Kay County, and appellate courts therefrom. Lender grants a limited
          ...
          arbitration in the United States District Court for the Northern
          District of Arizona or if such federal court fails to find
          jurisdiction, then in the courts of the state of Arizona sitting in
