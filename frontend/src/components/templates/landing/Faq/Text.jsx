...
export const list = (regexp) => [
          ...
          <li>
            <ul className="minimin-requirements-list">
              <li>
                <p>
                  <Highlighted
                    text="Recurring and verifiable source of income and minimum annual income of $20,000"
                    regexp={regexp}
                  />
                </p>
              </li>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <b>not</b> allow us{" "}
        <Highlighted
          text="to access, withdraw, credit or transfer funds from your account."
          regexp={regexp}
        />
      </p>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        on our website{" "}
        <Highlighted
          text="or reach out to our Customer Care team using the methods listed on our"
          regexp={regexp}
        />{" "}
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlighted
          text=" Istante Lending, LLC is a wholly-owned and operated entity of the Tonto
        Apache Tribe. The Company was established for the Tribe’s economic
        benefit and is organized under and operates pursuant to Tribal law. The
        Tonto Apache Tribe is a federally recognized Indian tribe and a
        sovereign nation, as expressly recognized under federal law. See 75 Fed.
        Reg. 60,810, 60,811. To learn more about the Tonto Apache Tribe, click"
          regexp={regexp}
        />{" "}
