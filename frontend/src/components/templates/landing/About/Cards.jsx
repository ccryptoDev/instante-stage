...
const config = [
  {
    ...
    text: (
      <p>
        ...
        <a href="tel:800-416-5770" className="link underline">
          800-416-5770
        </a>
        , or email us at{" "}
        <a
  ...
  },
  {
    ...
    text: (
      <p>
        ...
        or by email at{" "}
        <a href="mailto:CustomerCare@IstanteLending" className="link underline">
          {" "}
          CustomerCare@IstanteLending
        </a>
      </p>
    ),
  },
  {
    ...
    text: (
      <p>
        For general account inquiries, please call, or email us at{" "}
        <a
          href="mailto:CustomerCare@IstanteLending.com"
          className="link underline"
        >
